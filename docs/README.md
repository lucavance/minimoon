...
CLI with `moon install lampclaw/minimoon/cmd/minimoon@0.2.4`,
...
- [`guides/native_navigation.md`](guides/native_navigation.md) — native tabs, layout metrics and build-only PNG assets
